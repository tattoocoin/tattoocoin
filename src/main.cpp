...
uint256 hashGenesisBlock("0xa6d457f2154b6c2915f8282a886402ff830771bdefe9fccfb5b3c9f001bb2c4c");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // TattooCoin: starting difficulty is 1 / 2^12
...
{
    // TattooCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight == 1){
        nSubsidy = nSubsidy * 23076900 * 9  / 100 / 50;
     }
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // TattooCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // TattooCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // TattooCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa6d457f2154b6c2915f8282a886402ff830771bdefe9fccfb5b3c9f001bb2c4c");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1398508576;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085433222;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("TattooCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("TattooCoinMiner : ProcessBlock, block not accepted");
    }
...
void static LitecoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running TattooCoin with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("TattooCoinMiner terminated\n");
        throw;
    }
}
